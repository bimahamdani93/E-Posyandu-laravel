        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="/vaccination-schedules" method="POST" id="demo-form2" data-parsley-validate
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control" name="id_kategori">
                                        @foreach($category_vaccines as $category_vaccine)
                                            @if(old('id_kategori')===$category_vaccine->id )
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="nama" value="{{ old('hari', '') }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name" value="{{ old('tanggal', '') }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name" value="{{ old('jam', '') }}"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="number" id="first-name" value="{{ old('kuota', '') }}"
